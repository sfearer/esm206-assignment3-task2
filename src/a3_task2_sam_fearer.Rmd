...
# The name in row 49 is partially cut off, with the last of it's three elements no longer present in any column.
...
mpg_make_model <- mpg %>% # Start with mpg
  unite(col = make_model, # Create a new column called 'make_model'
        ...
        sep = "--" # Puts "--" between the pieces (default is underscore)
        ) 
...
some_dates <- c(10311991, 10311992, 10311993) 
